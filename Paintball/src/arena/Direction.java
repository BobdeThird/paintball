...
/**
 * This is a utility class consisting of helper methods which competitors may
 * use to help them design their Brains.
...
public class Direction {
     ...
     * directions.<p>
     * For example, a call to Direction.roundTo8(142) would return 135, while a
     * call to Direction.roundTo8(400) would return 45.
     ...
     * final space
     * @return a 2-element array {row, col} containing the coordinates
     * of the nearest adjacent space in the given direction
     */
     ...
     * Diagonal moves are permitted. Note that blockers and other obstacles
     * are disregarded.
     * @param row1 The row of the origin space
     * @param col1 The column of the origin space
     * @param row2 The row of the destination space
